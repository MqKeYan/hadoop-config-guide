...
1. **确认 Java 环境**  
   在`Master`服务器上输入`java -version`查询 Java 版本信息，确认 Java 版本与 Hadoop 适配（Hadoop 3.4.2 推荐的 JDK 版本不超过 11）。操作如图：
<p align="center">
  <img src="../../image/Eclipse%20Installation%20Diagram/P.png" width="80%">
</p>

2. **确认安装包**  
   在`用户根目录`(Xshell 连接 Master 服务器的默认地址，也就是`/home/user/`，其中`user`是你的用户名)上输入`ls`查询安装包版本是否正确版本信息。操作如图：
<p align="center">
  <img src="../../image/Eclipse%20Installation%20Diagram/P.png" width="80%">
</p>
