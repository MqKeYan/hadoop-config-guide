...
<p align="center">
  Languages:
  <a href="../SC/Virtual%20Network%20Configuration.md"> 简体中文 </a> ·
  <a href="../EN/Virtual%20Network%20Configuration_en.md"> English </a>
</p>

1. **虚拟网络编辑器**  
   在 VMware Workstation 中，依次点击`Edit`-`Virtual Network Editor`按钮打开虚拟网络配置器。操作如图：
<p align="center">
  <img src="../../image/Virtual%20Network%20Configuration%20Diagram/P1.png" width="80%">
</p>

2. **更改设置**  
   一般保持默认设置即可，如果地址冲突需要修改点击`Change Setting`按钮更改设置。操作如图：
<p align="center">
  <img src="../../image/Virtual%20Network%20Configuration%20Diagram/P2.png" width="60%">
</p>
...
<p align="center">
  <img src="../../image/Virtual%20Network%20Configuration%20Diagram/P3.png" width="60%">
</p>
