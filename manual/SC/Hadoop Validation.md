...
<p align="center">
  <img src="../../image/Hadoop%20Validation%20Diagram/P.png" width="60%">
</p>

2. **启动 Hadoop**  
   在`Msater`上分别使用`hdfs namenode -format`指令格式化文件系统`NameNode`，成功标志出现`Storage directory ... has been successfully formatted.`的提示。操作如图：  
   **注**
