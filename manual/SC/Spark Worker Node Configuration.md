...
1. **文件传输**  
   连接`HadoopMaster`服务器，分别使用`scp -r /home/user/Spark user@Slave1:~/`和`scp -r /home/user/Spark user@Slave2:~/`将配置好的 Spark 程序传输到服务器子机的根目录。
...
<p align="center">
  <img src="../../image/Spark%20Worker%20Node%20Configuration%20Diagram/P1.png" width="60%">
</p>

3. **验证安装**  
   输入`spark-shell --version`查询安装详情，出现例如`version 3.5.7`的版本信息表示安装成功。操作如图：
<p align="center">
  <img src="../../image/Spark%20Worker%20Node%20Configuration%20Diagram/P2.png" width="60%">
</p>
<p align="center">
  <img src="../../image/Spark%20Worker%20Node%20Configuration%20Diagram/P3.png" width="60%">
</p>
