...
- **Xshell Software**  
  Download and install Xshell 8.0 from the [Xshell official website](https://www.xshell.com/).
- **Xftp Software**  
  Download and install Xftp 8.0 from the [Xftp official website](https://www.xshell.com/).
...
- **VMware Workstation Installation**  
  ...
  Refer to: [VMware Installation Guide](manual/EN/VMware%20Installation.md)

- **Operating System Installation**  
  Install CentOS Stream 10 and deploy Linux-based virtualized applications.  
  Refer to: [Operating System Installation Guide](manual/EN/ISO%20Installation.md)
...
- **Xshell and Xftp Installation**  
  ...
  Refer to: [Xshell and Xftp Installation Guide](manual/EN/Xshell%20and%20Xftp%20Installation.md)

## System Configuration

- **Virtual Machine Cloning**  
  Clone the first virtual machine to create two additional virtual machines to form a Hadoop cluster.  
  Refer to: [Virtual Machine Cloning Guide](manual/EN/Server%20Cloning.md)
...
- **Virtual Network Configuration**  
  ...
  Refer to: [Virtual Network Configuration Guide](manual/EN/Virtual%20Network%20Configuration.md)
...
- **Hadoop Installation**  
  ...
  Refer to: [Hadoop Installation Guide](manual/EN/Hadoop%20Installation.md)

- **Hadoop Environment Variable Configuration**  
  Configure Hadoop environment files such as `hadoop-env.sh` and `yarn-env.sh`.  
  Refer to: [Hadoop Environment Variables Configuration Guide](manual/EN/Hadoop%20Environment%20Variables%20Configuration.md)
...
- **Hadoop Core Component Configuration**  
  ...
  Refer to: [Hadoop Core Configuration Guide](manual/EN/Hadoop%20Core%20Configuration.md)

- **Worker Node Configuration**  
  Copy Hadoop configuration and related files from the master node to all worker nodes.  
  Refer to: [Hadoop Worker Node Configuration Guide](manual/EN/Hadoop%20Worker%20Node%20Configuration.md)
...
- **Hadoop Validation**  
  ...
  Refer to: [Hadoop Validation Guide](manual/EN/Hadoop%20Validation.md)
...
- **Spark Installation**  
  ...
  Refer to: [Spark Installation Guide](manual/EN/Spark%20Installation.md)
...
- **Spark Basic Configuration**  
  ...
  Refer to: [Spark Configuration Guide](manual/EN/Spark%20Configuration.md)

- **Worker Node Configuration**  
  Copy Spark configuration and related files from the master node to all worker nodes.  
  Refer to: [Spark Worker Node Configuration Guide](manual/EN/Spark%20Worker%20Node%20Configuration.md)
