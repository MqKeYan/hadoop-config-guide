...
<p align="center">
  <strong> 注：简体中文以外的语言均使用机器翻译，若有翻译不到位的情况还请指点。如果作者不在没更新那就是去打卡丘了喵~请耐心等待或私信喵! </strong>
  <br>
  <strong> Note: Languages other than Simplified Chinese are machine-translated. If there are any inaccuracies in the translation, please feel free to point them out. Thank you very much! </strong>
  </br>
</p>
...
欢迎使用 **中文或英文** 进行 Issue、Discussion 和 Pull Request 交流。
如遇不当行为，请参考仓库中的 [`CODE_OF_CONDUCT.md`](./CODE_OF_CONDUCT.md)。
